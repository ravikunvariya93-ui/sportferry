...
export async function POST(request) {
  ...
  try {
    ...
    const totalAmount = venue.pricePerHour * 3 * slotList.length;
    ...
    for (let i = 0; i < parsedSlots.length; i++) {
      ...
      const commissionAmount = Math.round((venue.pricePerHour * 3) * COMMISSION_PERCENT / 100);
      ...
      const booking = await Booking.create([{
        ...
        startTime: times.startTime,
        endTime: times.endTime,
        totalAmount: venue.pricePerHour * 3,
